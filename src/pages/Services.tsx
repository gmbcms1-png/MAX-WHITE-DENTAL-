    ...
    <main>
      <section className="sec sec-srv">
        ...
        <div className="con">
          ...
          <div className="srv-consult">
            <div className="srv-consult-con">
              <span className="sec-tag">Personalized Care</span>
              <h3>Need a Custom Treatment Plan?</h3>
              <p>Every smile is unique. {SITE_CONFIG.clinic.doctorName} provides personalized consultations to understand your dental health and concerns before recommending any procedure.</p>
              <div className="srv-consult-btns">
                <a href={`https://wa.me/${SITE_CONFIG.contact.whatsapp}`} className="btn-green" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '10px' }}>
                  <svg viewBox="0 0 448 512" width="20" height="20" style={{ fill: '#fff' }}>
                ...
                <Link to="/contact" className="btn-outline">Book Appointment</Link>
              </div>
            </div>
          </div>
